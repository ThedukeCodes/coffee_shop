...
def create_app(test_config=None):
  ...
  # First thing you need to have in your code to create a CORS APP and set the origin header from which we will allow request (security level)*means everyone can send request 
  cors = CORS(app, resources={r"/api/*": {"origins": "*"}})


  #[DONE]@TODO: Use the after_request decorator to set Access-Control-Allow comment
  @app.after_request
  ...
  Note for me: within the endpoint the last headpoint parameter is a variable parameter (as they could be thousans, increasing categories_id)
  also "int" means integer we also could have set any datatype, this is called a "converter"
  '''
